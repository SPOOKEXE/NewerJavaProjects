...
public class BasicEntityBuilder {
	...
	public static Mesh createCube( double size, Vector3 position, Vector3 direction, Color color ) {
		...
		Quad faceUp = new Quad( v2, v3, v7, v6, color);
		Quad faceDown = new Quad( v1, v4, v8, v5, color);
	...
	public static Mesh createCube( double size, Vector3 position, Vector3 direction) {
		return createCube(size, position, direction, Color.RED);
	}
	
	public static Mesh createSphere( double diameter, int resolution, Vector3 position, Vector3 direction, Color color ) {
		...
		// DebugDump.DumpVector3List( points );
		...
		return new Mesh(tris, null);
	}
	
	public static Mesh createSphere( double diameter, int resolution, Vector3 position, Vector3 direction ) {
